            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-3xl mx-auto">
              <Card className="overflow-hidden hover:shadow-md transition-all">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-blue-600 text-sm mb-3">Visionary</p>
              ...
              <Card className="overflow-hidden hover:shadow-md transition-all">
                ...
                <Card className="overflow-hidden hover:shadow-md transition-all">
                <Image
                  src={"https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhCc3jx_71VXtuHiVHJA6fHAWAK4XmLUVyLIyTqnnTPdeVAZOTslnMo6Br2LMUebmfH5IBIxjdcbc1RFatgiu2kFVn8TLp5Z60Jsby1mHRVSL84l0rYJzt9PuA_hh3-CWOdrQjbsGtlgGLP9wdb7Zy0WogJxNeAAtaEZGeqY8I99Vf2z2TmLe2CdrgHFbI/s320/IMG_20250418_095100_827.jpg"}
