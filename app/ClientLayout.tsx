  ...
  return (
    <html lang="en">
      <head>
        <link
          rel="icon"
          href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi_YNWsB52TBODmpxuA02CXLsKnL4vYoHKfn8EN5aSEfF0Q3nmD2oI9PvN1GfW_uZhghTK1IjOekve6z-2JOnhb2VUqWfHrDq1_Qy1_Kvy0v5_RxrpZU8UHN5t0zywVhROEzBCq1VWwEfNrm2hKui_0C3ZwNMeskFmDCY3I_m17O5Vb0yXMRv2ZqWsu9TI/s320/IMG_20250418_095043_879.jpg"
        />
      </head>
      <body>
            ...
            <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <Card className="hover:shadow-md transition-all">
                  ...
                  <CardContent>
                    <p>
                      Learn in your preferred language with full support for both English and Nepali across all our
                      courses.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-md transition-all">
                  ...
                  <CardContent>
                    <p>
                      Earn badges, climb leaderboards, and track your progress to stay motivated throughout your
                      learning journey.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-md transition-all">
                  ...
                  <CardContent>
                    <p>
                      Get personalized career advice, skill assessments, and guidance to help you make informed
                      decisions.
                    </p>
                  </CardContent>
                </Card>
